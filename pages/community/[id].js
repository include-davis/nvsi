...
import { getCommunityAll, getCommunityMember } from "../../api-lib/apiOps";
      ...
      <main className={styles.main}>
        ...
        <div className={styles.headlineContainer}>
          <div className={styles.subheadlineContainer}>
            ...
            <span id={styles.subtitle}>{profile.Description}</span>
          </div>
        ...
        <div className={styles.bodyContainer}>
          <div className={styles.articleContainer}>
            ...
            >
              ...
              <img className={styles.profilePhoto} src={"https://data.whicdn.com/images/349471368/original.jpg"}></img>
              ...
              <ul id={styles.links}>
                ...
                <li>
                  ...
                  <a href={`mailto:${profile.memberEmail}`}> {profile.memberEmail} </a>
                </li>
              </ul>
...
export async function getStaticPaths() {
  ...
  const profiles = await getCommunityAll()
